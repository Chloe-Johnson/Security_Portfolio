...
![The following screenshot displays](Security_Portfolio/ELK-Stack-Project/ELK-vm-docker-ps.png) the result of running `docker ps` after successfully configuring the ELK instance.
